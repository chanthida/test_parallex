                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    ...
                                                    <textarea rows="4" class="form-control no-resize" placeholder="Header" name="edit_header"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group ">
                                                <div class="form-line">
                                                    ...
                                                    <textarea rows="4" class="form-control no-resize" placeholder="Content" name="edit_content"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
